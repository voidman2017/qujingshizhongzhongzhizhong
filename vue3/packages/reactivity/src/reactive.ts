...
export function reactive(target: object) {
  console.log('===debug=== reactive run', times++)
...
function createReactiveObject(
  ...
  if (
    ...
    // console.log(
    //   '===debug=== target[ReactiveFlags.RAW]: ',
    //   target[ReactiveFlags.RAW],
    // )
    return target
  }
  ...
  if (existingProxy) {
    // console.log('===debug=== existingProxy: ', target)
  ...
  if (targetType === TargetType.INVALID) {
    // console.log('===debug=== targetType === TargetType.INVALID: ', target)
    return target
  }
  /* 5. 创建 Proxy：根据目标类型选择不同的处理器 !!! */
  /* console.log(
    '===debug=== targetType === TargetType.COLLECTION: ',
